...
public class Grille {
    ...
    /**
     * Méthode qui permet de vérifier que les dernières cases non découvertes 
     * soient bien toutes des bombes pour finir la partie
     * @return true si les cases restantes sont des bombes
     */
    ...
    /**
     * permet de découvrir toutes les cellules restantes
     *
     */
    ...
    /**
     * Ajoute un drapeau au nombre de drapeau déjà présent
     ...
     * @return la grille après avoir enlever un drapeau
     * */
